...
class GluonSemantic(TritonSemantic[TensorTy]):
    ...
    def mfma(self, input: TensorTy, other: TensorTy, acc, layout, input_precision, max_num_imprecise_acc, out_dtype):
        ret_type = ttgl.distributed_type(out_dtype, acc.shape, layout)

        return super().dot(input, other, acc, input_precision, max_num_imprecise_acc, out_dtype, ret_type)
